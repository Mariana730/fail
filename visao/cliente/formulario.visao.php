...
<form action="" method="POST">
    ...
    <input type="text" placeholder="Data: dd/mm/aaaa"  name="datadenascimento" value="<?=@$usuarios['datadenascimento']?>"><br><br>
	
    <input type="radio" name="sexo" value="M"> Masculino
    <input type="radio" name="sexo" value="F"> Feminino
    <input type="radio" name="sexo" value="O"> Outro <br><br>
        
    <input type="text" placeholder="Tipo de usuário"  name="tipousuario" value="<?=@$usuarios['tipousuario']?>">
